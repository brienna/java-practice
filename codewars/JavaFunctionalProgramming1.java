/* With the release of Java 8, Java has finally added support for 
 * "lambda functions", that is, variables that contain a function 
 * which can operate on data just as class methods can (well, not 
 * just as class methods can...)
 *
 ...
 * the concept of functions that can be passed as variables should not be 
 * anything new. The syntax in Java should even look familiar:
 *
 ...
 * 
 * The above is a simple mapper function: given an input of type MyObject, 
 * return a specific result of type String, in this case the toString of 
 * the object. They can, of course, become much more complicated.
 * 
 ...
 * }
 *
 * Write a Function (with the appropriate types) that returns true if 
 * a given student is "John Smith" with a student number of "js123" 
 * (otherwise return false).
 */

import java.util.function.Function;

public class JavaFunctionalProgramming1 {
